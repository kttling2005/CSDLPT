CREATE DATABASE IF NOT EXISTS BanHangDaKho_DN;
USE BanHangDaKho_DN;

SET FOREIGN_KEY_CHECKS = 0;

drop table if exists Kho, TonKho_DN, SanPham, DanhMuc, NhapXuatKho_DN;
...
CREATE TABLE TonKho_DN (
    ...
    CONSTRAINT FK_TonKhoDN_Kho
        FOREIGN KEY (MaKho) REFERENCES Kho(MaKho),

    CONSTRAINT FK_TonKhoDN_SanPham
        FOREIGN KEY (MaSP) REFERENCES SanPham(MaSP)
) ENGINE=InnoDB;

CREATE TABLE NhapXuatKho_DN (
...
-- Thêm dữ liệu vào bảng TonKho_DN
INSERT INTO TonKho_DN (MaKho, MaSP, SoLuong) VALUES
('KH_DN01', 'SP01', 45),  
('KH_DN01', 'SP02', 35),  
('KH_DN01', 'SP03', 20),   
('KH_DN02', 'SP01', 12),   
...
-- Dữ liệu mẫu cho bảng NhapXuatKho_DN
INSERT INTO NhapXuatKho_DN (MaNX, MaKho, MaSP, LoaiGD, SoLuong, GhiChu) VALUES
('NXDN001', 'KH_DN01', 'SP01', 'NHAP', 90, 'Nhập thêm iPhone 15 từ nhà cung cấp Apple'),
('NXDN002', 'KH_DN01', 'SP02', 'NHAP', 70, 'Nhập thêm Samsung Galaxy S24 Ultra'),
('NXDN003', 'KH_DN01', 'SP01', 'XUAT', 15, 'Xuất bán cho khách lẻ'),
('NXDN004', 'KH_DN02', 'SP04', 'NHAP', 40, 'Nhập laptop ASUS Vivobook'),
('NXDN005', 'KH_DN02', 'SP05', 'XUAT', 3, 'Xuất kho giao khách điện máy'),
('NXDN006', 'KH_DN02', 'SP03', 'NHAP', 18, 'Nhập thêm MacBook Air M3');
